...
# corner width is equal to padD, bondpad outside set cornerToPad [expr {$padBond + $padD}]
...
place_pad -row IO_EAST  -location [expr {$eastStart +  1*$eastPitch}] "pad_slink_ddr_rcv_clk_o"        ; # pin no:  2
place_pad -row IO_EAST  -location [expr {$eastStart +  2*$eastPitch}] "pad_slink_ddr0_o"               ; # pin no:  3
place_pad -row IO_EAST  -location [expr {$eastStart +  3*$eastPitch}] "pad_slink_ddr1_o"               ; # pin no:  4
place_pad -row IO_EAST  -location [expr {$eastStart +  4*$eastPitch}] "pad_slink_ddr2_o"               ; # pin no:  5
place_pad -row IO_EAST  -location [expr {$eastStart +  5*$eastPitch}] "pad_slink_ddr3_o"               ; # pin no:  6
place_pad -row IO_EAST  -location [expr {$eastStart +  6*$eastPitch}] "pad_slink_ddr4_o"               ; # pin no:  7
place_pad -row IO_EAST  -location [expr {$eastStart +  7*$eastPitch}] "pad_slink_ddr5_o"               ; # pin no:  8
place_pad -row IO_EAST  -location [expr {$eastStart +  8*$eastPitch}] "pad_slink_ddr6_o"               ; # pin no:  9
place_pad -row IO_EAST  -location [expr {$eastStart +  9*$eastPitch}] "pad_slink_ddr7_o"               ; # pin no: 10
place_pad -row IO_EAST  -location [expr {$eastStart + 10*$eastPitch}] "pad_slink_ddr8_o"               ; # pin no: 11
place_pad -row IO_EAST  -location [expr {$eastStart + 11*$eastPitch}] "pad_slink_ddr9_o"               ; # pin no: 12
place_pad -row IO_EAST  -location [expr {$eastStart + 12*$eastPitch}] "pad_slink_credit_recv_clk_i"    ; # pin no: 13
...
place_pad -row IO_NORTH -location [expr {$northStart -  3*$northPitch}] "pad_slink_credit_rtrn_clk_o"  ; # pin no:  4
place_pad -row IO_NORTH -location [expr {$northStart -  4*$northPitch}] "pad_slink_ddr9_i"             ; # pin no:  5
place_pad -row IO_NORTH -location [expr {$northStart -  5*$northPitch}] "pad_slink_ddr8_i"             ; # pin no:  6
place_pad -row IO_NORTH -location [expr {$northStart -  6*$northPitch}] "pad_slink_ddr7_i"             ; # pin no:  7
place_pad -row IO_NORTH -location [expr {$northStart -  7*$northPitch}] "pad_slink_ddr6_i"             ; # pin no:  8
place_pad -row IO_NORTH -location [expr {$northStart -  8*$northPitch}] "pad_slink_ddr5_i"             ; # pin no:  9
place_pad -row IO_NORTH -location [expr {$northStart -  9*$northPitch}] "pad_slink_ddr4_i"             ; # pin no: 10
place_pad -row IO_NORTH -location [expr {$northStart - 10*$northPitch}] "pad_slink_ddr3_i"             ; # pin no: 11
place_pad -row IO_NORTH -location [expr {$northStart - 11*$northPitch}] "pad_slink_ddr2_i"             ; # pin no: 12
place_pad -row IO_NORTH -location [expr {$northStart - 12*$northPitch}] "pad_slink_ddr1_i"             ; # pin no: 13
place_pad -row IO_NORTH -location [expr {$northStart - 13*$northPitch}] "pad_slink_ddr0_i"             ; # pin no: 14
place_pad -row IO_NORTH -location [expr {$northStart - 14*$northPitch}] "pad_slink_ddr_rcv_clk_i"      ; # pin no: 15
