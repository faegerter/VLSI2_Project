...
module croc_vip #(
  ...
  task automatic jtag_wait_for_eoc(output bit [31:0] exit_code);
    ...
    /*if (exit_code)
      ...
      $display("@%t | [JTAG] Simulation finished: SUCCESS", $time);
      begin
        logic [31:0] cyc_start, cyc_end, cyc_diff, ns_val;
        jtag_read_reg32(32'h04000F00, cyc_start);
        jtag_read_reg32(32'h04000F04, cyc_end);
        jtag_read_reg32(32'h04000F08, cyc_diff);
   
        $display("@%t | [TIMING] start=%0d cycles, end=%0d cycles difference= %0d ",
