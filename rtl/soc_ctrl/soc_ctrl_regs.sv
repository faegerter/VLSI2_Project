...
module soc_ctrl_regs #(
  ...
  //   [12:5]  sram_bank_words Words per (small/base) SRAM bank / 64 (croc_pkg::SmallSramBankNumWords)
  //                           Note: banks may differ in size; the last bank is the large bank.
  ...
  localparam logic [31:0] HwInfoWord = {
    ...
    8'(SmallSramBankNumWords / 64),    // [11:5]  sram_bank_words (in units of 64 words)
    5'b0                               // [4:0]   reserved
  };
