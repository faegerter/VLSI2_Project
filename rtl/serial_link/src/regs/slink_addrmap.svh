...
`define SLINK_REG_GLOBAL_ADDR_REG_ADDR   64'h0000000C
`define SLINK_REG_GLOBAL_ADDR_REG_OFFSET 64'h0000000C

`define SLINK_REG_RAW_MODE_EN_REG_ADDR   64'h00000010
`define SLINK_REG_RAW_MODE_EN_REG_OFFSET 64'h00000010

`define SLINK_REG_RAW_MODE_IN_DATA_REG_ADDR   64'h00000014
`define SLINK_REG_RAW_MODE_IN_DATA_REG_OFFSET 64'h00000014

`define SLINK_REG_RAW_MODE_IN_CH_SEL_REG_ADDR   64'h00000018
`define SLINK_REG_RAW_MODE_IN_CH_SEL_REG_OFFSET 64'h00000018

`define SLINK_REG_RAW_MODE_OUT_DATA_FIFO_REG_ADDR   64'h0000001C
`define SLINK_REG_RAW_MODE_OUT_DATA_FIFO_REG_OFFSET 64'h0000001C

`define SLINK_REG_RAW_MODE_OUT_DATA_FIFO_CTRL_REG_ADDR   64'h00000020
`define SLINK_REG_RAW_MODE_OUT_DATA_FIFO_CTRL_REG_OFFSET 64'h00000020

`define SLINK_REG_RAW_MODE_OUT_EN_REG_ADDR   64'h00000024
`define SLINK_REG_RAW_MODE_OUT_EN_REG_OFFSET 64'h00000024

`define SLINK_REG_FLOW_CONTROL_FIFO_CLEAR_REG_ADDR   64'h00000028
`define SLINK_REG_FLOW_CONTROL_FIFO_CLEAR_REG_OFFSET 64'h00000028
